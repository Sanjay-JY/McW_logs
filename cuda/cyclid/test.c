...
/*
// dim3 NUM_THREADSL(170,6);
    // dim3 NUM_BLOCKSL((16640)+1,1,1);

    // int gtid=blockIdx.x*blockDim.x+threadIdx.x;
    // int tid=threadIdx.y;
    // int phaseBinIdx, phaseBin, expIdx;
    // int ilag=gtid%65;
    // int index[6]={0, 168, 336, 504, 672, 840};
    // if(tid<16640)
    // {
    //     int start=tid*42698;
    //     int end=start+42698;
    ...
    //                 if(expIdx==gtid)
    //                 {
    //                     lookuptable[(expIdx*1003) + index[tid]].x = i;
    //                     lookuptable[(expIdx*1003) + index[tid]].y = i+ilag;
    //                     index[tid]++;
    //                 }
    //             //}
    //         }
    ...
    //                     lookuptable[(expIdx*1003) + index].y = i+ilag;
    //                     atomicAdd(&index,1);
    //                 }
    //             //}
    //         }
